...
<div style="position: absolute" v-click="0" v-click.hide="1" v-motion :initial="{x: 0}" :enter="{x: 0}" :leave="{x: -80}">
...
<div v-click="1" v-motion :initial="{x: 80}" :enter="{x: 0}" :leave="{x: 0}">

<img v-click="2" style="float: right; max-width: 40%" src="./skull.png" />
